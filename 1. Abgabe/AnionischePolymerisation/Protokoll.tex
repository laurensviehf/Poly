...
\section{Theorie}
	...
	anionische- oder eine kationische-Polymerisation handelt. 
	Ebenfalls hat die effektive Ladung der Endgruppen einen starken Einfluss auf die Polymerisation. Die Ladung wird dabei maßgeblich vom Lösungsmittel beeinflusst, indem 
	es die Dissoziation und Stabilisierung von Ionenpaaren beeinflusst. So zeigt die Abbildung \ref{Ladungsggw} wie die Ionen in abhängigkeit der 
	Polarität der Lösungsmittel in Lösung vorliegen. Polare Lösungsmittel solvatisieren die Ionen, wodurch diese getrennt voneinander vorliegen und eine hohe 
	Verfügbarkeit der effektiven Ladung hervorrufen. Mit fallender Polarität liegen die Ionen weniger getrennt vor, womit die effektive Ladung sinkt und somit ebenfalls 
	die Reaktivität und die Reaktionsgeschwindigkeit sinkt. Die Reaktionsgeschwindigkeit sinkt dabei ab, weil assozierte- und Kontaktionenpaare schwerer zugänglich sind 
	und somit die Nukleophilie abgeschirmt ist. Dazu ist es für die Monomere schwerer sich zwischen Kation und Anion anzulagern und zu Polymerisieren, da diese Räumlich 
	sehr nah zueinander stehen und aufgrund von Coulomb-Kräften angezogen werden.
...
\section{Auswertung}
	...
	Nach Ermittlung der Massen durch GPC konnte folgende Kurve erhalten werden:
		...
		\begin{figure}[H]
			...
			\caption{Die Abbildung zeigt das GPC-Chromatogramm zu dem erhaltenen Copolymer.}
			\label{GPCKurve}
		\end{figure}
...
\section{Fragen}
	...
	\subsection{Frage 3}
		...
		Bei THF ist das Problem in der Polarität, da THF polar ist und Toluol unpolar. Daher wird das Toluol lieber verwendet, da dieses unpolarer und aromatisch ist.
