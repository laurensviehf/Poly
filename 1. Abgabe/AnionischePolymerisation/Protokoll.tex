...
<<<<<<< HEAD
	...
	ein Makroanion oder Makrokation. Die Ladung des Makroions entscheidet hierbei darüber ob es sich um eine 
...
>>>>>>> e4a6d42ee9444bb8e6f1cc62e8f390caa63cda18
	...
	Die Polarität des Lösemittels kann die Ladungen unterschiedlich gut Stabiliesieren. 
	...
	So ist durch ein vorliegen eines Kovalenten Ions die Reaktivität sowie Nukleophilie verringert da die Ladung "abgefangen" wird
	...
	dass bei der ionischen Polymerisation die Möglichkeit besteht, diese lebend durchzuführen, da keine bimolekulare Terminierungsreaktionen stattfinden können. 
	Somit kann die Polymerisation theoretisch
	endlos aufrecht erhalten bleiben, bzw. sie kann durch erneute Zugabe von Monomer weitergeführt werden.
<<<<<<< HEAD
	Diese wird nur durch Zugeben einer terminierenden Substanz abgebrochen, es wird auch von \textquotedblleft abtöten\textquotedblright \, 
	gesprochen.
=======
	Diese kann gezielt Terminiert werden, es wird auch von \textquotedblleft Abtöten\textquotedblright \, gesprochen.
>>>>>>> e4a6d42ee9444bb8e6f1cc62e8f390caa63cda18
	...
	\subsection{Ablauf der lebenden Anionische Polymerisation}
		...
		Der erste Schritt ist die Initiierung. Hierfür werden bei der anionischen Polymerisation Brönsted Basen verwendet.
		Hierbei gilt die Regel je weniger elekrophil das Zentrum ist, umso stärker muss die Base sein.
		...
		Das hierraus entstandene radikalanionische Monomer rekombiniert und weist anschließend zwei aktive anionische Enden auf.
			...
			\begin{figure}[H]
				...
				\caption{Die Abbildung zeigt den Initiierungsschritt von Styrol mittels eines Alkalimetallnaphthaliden.\cite{polyskript}}
		...
		So ergibt sich der Polymerisationsgrad $\bar{P}_\text{n}$ wie folgt:
		...
		und [I] ist die Initiatorkonzentration. Aus P$_\text{n}$ lässt sich der Polydispersitätsindex ($\DH$) berechnen. 
...
\newpage
		...
		Dabei gilt, welches das synthetische Polymere mit einem unendlichen Polymerisationsgrad den PDI von 1 zu haben.
...
\section{Durchführung}
	...
	In einem Schlenkzweihals mit glasummanteltem Rührfisch wurde Toluol (\SI{40,0}{ml}) vorgelegt und auf \SI{50}{°C} hochgeheizt.
	Anschließend wurde Styrol (\SI{3,00}{ml}, \SI{26,2}{mmol}) und zuletzt AIBN in Cyclohexan (\SI{0,30}{ml}, \SI{1,40}{\frac{mol}{l}}) zugegeben.
	Nach 30 min wurde Isopren (\SI{2,00}{ml}, \SI{20,0}{mmol}) zugegeben und weitere 2 h gerührt. 
	Zur terminierung der Reaktion wurde Methanol (\SI{0,50}{ml}) zu der Lösung gegeben, 
	in ca. \SI{400}{ml} gekühltem Methanol gefällt und im Vakuumtrockenschrank getrocknet.
