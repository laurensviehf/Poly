...
\section{Theorie}
	...
	\subsection{Metallische Polyinsertionen}
		...
		Dabei wird zwischen isotaktisch (in Abb. \ref{taktizitäe} mitte), syndiotaktisch (in Abb. \ref{taktizität} rechts) und in ataktisch (in Abb. \ref{taktizität} links) unterschieden.
