...
\newpage
	...
	\subsection{Bestimmung der HOMO- und LUMO-Niveaus}
		...
		Diese werden anschließend noch mit dem Fermi-Skalar verrechnet, wobei
		Die Energiedifferenz dieser beiden Werte liegt dabei bei

		\begin{equation*}
			band \, gap = |\SI{-0,31}{eV} - \SI{2,26}{eV}| = \SI{2,57}{eV}
		\end{equation*}

		und beschreibt den HOMO-LUMO-Abstand. Und es Folgen die jeweiligen Energieniveaus für HOMO und LUMO:
