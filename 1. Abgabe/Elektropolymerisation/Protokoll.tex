...
\section{Theorie}
	...
	gleichbleibendes Potenzial besitzt. Ebenfalls muss das Potenzial der Ferrocen/Ferrocenium Elektrode vorerst gemessen werden, da diese je nach 
...
\section{Auswertung}
	...
	\subsection{Standardmessung der Ferrocen/Ferrocenium Elektrode}
		...
		Dabei wurde ein Ferrocen/Ferrocenium (Fc/Fc$^+$) Zusatz verwendet mit einer Ag/AgCl-Elektrode als Gegenelektrode.
		Das aufgenommene CV ist in Abbildung \ref{CV-Fe} aufgezeigt.
			\begin{figure}[H]
				\centering
				\includegraphics[scale = 0.5]{Bilder/Ferrocen.png}
				\caption{Die Abbildung zeigt das CV von einem Ferrocen/Ferrocenium Zusatz mit einer Ag/AgCl-Elektrode als Gegenelektrode.
	...
	\subsection{Elektropolymerisation von EDOT}	
		...
		Durch analysieren des Graphen werden nicht nur die drei Oxidationspeaks rechts erkennbar, sondern auch ein kleiner Peak im Bereich von $\SI{-0,7}{V}$ zu erkennen.
...
\newpage
	...
	\subsection{Bestimmung der HOMO- und LUMO-Niveaus}
		...
		Denn bei längeren koordinierten $\pi$-Systemen ist der HOMO-LUMO-Abstand kleiner und kann leichter oxidiert werden. Daher wird das 
