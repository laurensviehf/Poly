...
\section{Experimental part}
	...
	The initial measurements involved rotational measurements. First, the flow behavior of honey, a 14% PVP solution, and a starch-water suspension 
	was investigated. For the investigation, a varying shear rate of $\dot{\gamma} = 0,1$ to $\SI{500}{s^{-1}}$ was applied to the honey, a 
	shear rate of $\dot{\gamma} = 5000$ to $\SI{1}{s^{-1}}$ to the PVP solution, and a shear rate of $\dot{\gamma} = 1$ to $\SI{100}{s^{-1}}$ to 
	the starch-water suspension. 
...
\section{Results}
	...
	\subsection{Rotational measurements}
		...
		Meaning it has a viscosity and shear stress decrease with increasing deformation velocity.
		...
		The next measurement of this exercise was the measurement of a 50\% starch solution. Figure \ref{starch} shows a clear exponential function which points to a non newtonian shear thickening fluid.
		Meaning the viscosity and shear stress is increasing when increasing the deformation velocity.
	...
	\subsection{Time dependant measurement of the viscosity}
		...
		After examination of Figure \ref{ketchup}, a difference between the viscosity before and after applying the high deformation velocity is visible.
