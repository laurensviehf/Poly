...
\subsection{Kinetik der radikalischen Polymerisation}
	...
	Radikalkonzentration leicht polymerisiert. Bei fast 100 \% Umsatz lässt dann die Geschwindigkeit nach, da die Monomerkonzentration stark gegen null geht. \cite{polyskript}
		...
		\begin{figure}[H]
			...
			\caption{Die Abbildung zeigt den Norrish-Trommsdorff-Effekt Graphish dargestellt.\cite{noauthor_dateipolymerisationsverlauf_2018}}
			\label{NTE}
		\end{figure}
		...
		Somit gibt es ein Pfropfende und die Querketten [\ref{Propf}]
			...
			\begin{figure}[htbp]
				...
				\begin{subfigure}[b]{0.45\textwidth}
					...
					\caption{Abfolge eines Bolckcopolymers. \cite{noauthor_copolymer_2025}}
					\label{Block}
				\end{subfigure}
				...
				\begin{subfigure}[b]{0.45\textwidth}
					...
					\caption{Abfolge eines Pfropfcopolymers.\cite{noauthor_copolymer_2025}}
					\label{Propf}
				\end{subfigure}
