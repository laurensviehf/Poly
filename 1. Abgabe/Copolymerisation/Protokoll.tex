...
\subsection{Kinetik der radikalischen Polymerisation}
	Für diese Kinetik spielt das sogenannte Wurzel-I-Gesetz eine große Rolle. 
...
\section{Auswertung}
	...
	\subsection{Versuch 1}
		...
		Diese Werte, sowie die der anderen zwei Proben, sind in Tabelle \ref{Tabelle1} gelistet.
			...
			\begin{table}[ht]
				...
				\begin{tabular}{ccccccccc}
					\toprule
					\textbf{Probe} & \textbf{Initiator-Einwaage (mg)} & \textbf{[I] (mmol/L)} & \textbf{$m_{ps}$ (g)} & \textbf{$m_{st}$ (g)} & \textbf{$n_{st}$ (mol)} & \textbf{$U$ (\%)} & \textbf{$\Delta M$} & \textbf{$v_{Br}$} \\
					\midrule
					1 & 2,60  & 1,58 & 0,32 & 8,78 & 0,08 & 0,04 & 0,31 & $0,043 \cdot 10^{-3}$ \\
					2 & 10,10 & 6,15 & 0,63 & 8,47 & 0,08 & 0,07 & 0,60 & $0,084 \cdot 10^{-3}$ \\
					3 & 24,60 & 14,98 & 0,93 & 8,17 & 0,08 & 0,10 & 0,89 & $1,24 \cdot 10^{-3}$ \\
					\bottomrule
				\end{tabular}%
				}
		\end{table}
		...
		Die Fitgerade wird über folgende Gleichung beschrieben:
			...
			\begin{equation}
				\log(v_\text{Br}) = 0.48  \cdot \log([I]) - 3.03
			\end{equation}
		...
		Der idealwert von 0,5 beschreibt, die Reaktionsordnung in Bezug auf den Initiator.
		Dieser sollte 0,5 sein da dies die Potenz der Initiatorkonzentration im Wurzel-I Gesetz beschreibt.
		...
		Dies wird über folgende Gleichung erreicht:
			...
			\begin{equation}
				k = 10^{-3.0318- \log{[M]}} = 0,106 \cdot 10^{-3}
			\end{equation}
	...
	\subsection{Versuch 2}
		...
		\begin{table}[ht]
			...
			\begin{tabularx}{\textwidth}{@{} c *{8}{X} @{}}
				...
				\midrule
				1 & 20,83 & 85,77 & 1,00 & 2,57 & 0,24 & 0,2 & 0,86 & 0,23 \\
				2 & 20,83 & 32,04 & 1,00 & 0,96 & 0,65 & 0,2 & 0,32 & 0,63 \\
				3 & 20,83 & 14,02 & 1,00 & 0,42 & 1,49 & 0,2 & 0,14  & 1,43 \\
				4 & 20,83 & 9,34  & 1,00 & 0,28 & 2,23 & 0,2 & 0,09 & 2,15 \\
				5 & 20,83 & 5,01  & 1,00 & 0,15 & 4,16 & 0,2 & 0,05 & 4,00 \\ 
				\bottomrule
			\end{tabularx}
		\end{table}
	 ...
	 \subsubsection{Copolymerisationsparameter nach Mayo und Lewis}
		...
		Darüber lassen sich nun die Durchschnitte berechnen, welche \O $r_\text{St} = 4.15$ und \O $r_\text{MMA} = 8,62$ betragen. 
	...
	\subsubsection{Copolymerisationsparameter nach Fineman und Ross}
		...
		Die r Werte sind beide ungefähr 1, wodurch die Werte im Copolymerisationsdiagramm fast der Winkelhalbierenden entsprechen.
		Dabei ist jedoch r1>1 und r2<1 wodurch den Verlauf einer Wurzelfunktion annimmt.  
\section{Fragen}
	...
	\subsection{Frage 8}
		...
		Dabei werden diese meist in Kombination verwendet da jede dieser Methoden eigene Vor- und Nachteile mit sich bringen.
		So werden Beispielsweise bei IR-Spektroskopie lediglich die Funktionellen Gruppen bestimmt.
		Bei NMR müssen die Endgruppen bekannt sein jedoch kann über NMR schnell der Umsatz bestimmt werden.
		Bei UV/Vis mü+ssen Gruppen vorhanden sein, welche Übergänge im sichtbaren Bereich haben.
