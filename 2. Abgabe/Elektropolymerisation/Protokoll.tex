...
\newpage
	...
	\subsection{Bestimmung der HOMO- und LUMO-Niveaus}
		...
		\begin{equation*}
			band \, gap = |\SI{-5,41}{eV} - \SI{-7,36}{eV}| = \SI{1,95}{eV} \text{.}
		\end{equation*}
	...
	\subsection{Elektrochrome Eigenschaften von PEDOT}
		...
		Leitfähigkeit von PEDOT sehr gering, weshalb es Zeit benötigt die Elektronen durch die Schicht PEDOT zu transportieren und die gesamte Schicht 
		zu oxidieren bzw. zu reduzieren. 
