...
\section{Theory}
	...
	\subsection{Basic concepts}
		...
		$x$ and $y$ represent the coordinate axes, with $x$ pointing in the direction of the force $F$. \\
		...
		conversely, if they decrease, it is referred to as a non-Newtonian shear-thinning fluid. The curves can be seen in Figure.
...
\section{Results}
	...
	\subsection{Time dependant measurement of the viscosity}
		...
		This behaviour is typicall for 
