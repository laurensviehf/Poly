...
\section{Theory}
	...
	\subsection{Basic concepts}
		...
		For example, Figure \ref{flies} shows the experimental behaviour of a Newtonian fluid, Figure \ref{flies} that of a shear-thinning fluid, and Figure \ref{flies} 
		that of a shear-thickening fluid. \cite{polyskript}

		\begin{figure}
			\centering
			\includegraphics[scale = 0.6]{Bilder/Fliesgraph.png}
			\caption{The picture shows the shear thinning and the shear thickening trend, and the for the newtonian fluid aswell.}
			\label{flies}
		\end{figure}
