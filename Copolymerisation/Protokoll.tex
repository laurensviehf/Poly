...
\section{Auswertung}
	...
	\subsection{Versuch 2}
		...
		und die restlichen Werte, sowie die konzentrationen sind in Tabelle \ref{VerhältnisseV2} aufgeführt.
	
			\begin{table}[H]
				\centering
				\caption{Aufgelistet sind die Massenverhältnis und Stoffmengenkonzentrationen von Styrol und MMA bei den unterschiedlichen Proben.}
				\label{VerhältnisseV2}
				\begin{tabular}{|c|c|c|c|}
				\hline
				\textbf{Probe} & $\frac{m_\text{Styrol}}{m_\text{MMA}}$ & $[Styrol]$ $\frac{mmol}{l}$ & $[MMA]$ $\frac{mol}{l}$\\
				1 & 0,243  & 1,456 & 7,824 \\
				2 & 0,650  & 2,912 & 6,259 \\
				3 & 1,486  & 4,369 & 4,694 \\
				4 & 2,229  & 5,825 & 3,130 \\
