...
\subsection{Kinetik der radikalischen Copolymerisation}
	...
	Dabei die Copolymerisationsgleichung so umgeformt, das beide $r$ die Steigung und den Koordinatenabschnitt angeben.
...
\section{Auswertung}
	...
	\subsection{Versuch 1}
		...
		Diese Werte sowie die der anderen zwei Proben sind in Tabelle \ref{Tabelle1} gelistet.
			...
			\begin{table}[ht]
				...
				\begin{tabular}{ccccccccc}
					...
					\midrule
					1 & 2,60  & 0,001583338 & 0,32 & 8,78 & 0,08430149 & 0,03516484 & 0,30724916 & $4,26735 \cdot 10^{-5}$ \\
					2 & 10,10 & 0,006150661 & 0,63 & 8,47 & 0,08132501 & 0,06923077 & 0,60489678 & $8,40134 \cdot 10^{-5}$ \\
					3 & 24,60 & 0,014980817 & 0,93 & 8,17 & 0,07844455 & 0,10219780 & 0,89294287 & 0,00012402 \\
					\bottomrule
				\end{tabular}%
				}
		\end{table}
		...
		Dies ist ziemlich gut wenn man diesen mit dem theoretischen Wert von 0,5 vergleicht.
	...
	\subsection{Versuch 2}
		...
		\begin{table}[ht]
			...
			\begin{tabularx}{\textwidth}{@{} c *{8}{X} @{}}
				\toprule
				\textbf{Probe} & \textbf{$m_{St}$} & \textbf{$m_{MMA}$} & \textbf{$I_{St}$} & \textbf{$I_{MMA}$} & \textbf{$\frac{m_{St}}{m_{MMA}}$} & \textbf{$n_{St}$} & \textbf{$n_{MMA}$} & \textbf{$\frac{n_{St}}{n_{MMA}}$} \\
				\midrule
				1 & 1,8 & 9,40 & 1,0 & 2,57 & 0,2429 & 0,0173 & 0,0939 & 0,1841 \\
				2 & 3,6 & 7,52 & 1,0 & 0,96 & 0,6502 & 0,0346 & 0,0751 & 0,4602 \\
				3 & 5,4 & 5,64 & 1,0 & 0,42 & 1,4861 & 0,0518 & 0,0563 & 0,9204 \\
				4 & 7,2 & 3,76 & 1,0 & 0,28 & 2,2291 & 0,0691 & 0,0376 & 1,8408 \\
				5 & 9,0 & 1,88 & 1,0 & 0,15 & 4,1610 & 0,0864 & 0,0188 & 4,6020 \\
				\bottomrule
			\end{tabularx}
		\end{table}
	 ...
	 \subsubsection{Copolymerisationsparameter nach Mayo und Lewis}
		...
		Daraus folgen dann folgende gleichungen.
		...
		Diese Aufgestellten Geradenfunktionen können graphisch Aufgetragen werden, und es kann Graph \ref{VoodooShit} erhalten werden.
	...
	\subsubsection{Copolymerisationsparameter nach FIneman und Ross}
		...
		Bei der Methode nach Fineman und Ross wird etwas anders vorgegangen.
		Dabei wird Gleichung \ref{FinemanRoss} können mit den Werten aus Tabelle \ref{Tabelle-Versuch2} die Punkte erhalten und aufgetragen werden.
		...
		Für die restilichen proben wurde analog vorgegangen und die Werte sind in Tabelle \ref{Tabelle-Fineman} gelistet.
			...
			\begin{table}[ht]
				...
				\begin{tabular}{cc}
					\toprule
					\textbf{$\frac{n_{St}}{n_{MMA}} \cdot \left(1 - \frac{1}{m_{St}/m_{MMA}}\right)$} & \textbf{$\frac{n_{St}^2}{n_{MMA}^2} \cdot \frac{1}{m_{St}/m_{MMA}}$} \\
					\midrule
					-0,5739 & 0,1395 \\
					-0,2476 & 0,3258 \\
					0,3010  & 0,5701 \\
		...
		Diese Werte können geplottet werden und es kann eine Ausgleichsgerade sowie der Achsenabschnitt bestimmt werden.
		Welche den Werten $r_1$ und $r_2$ entsprechen.

			\begin{figure}[H]
				\centering
				\includegraphics[scale = 0.5]{Bilder/GraphFineman.png}
				\caption{Der Glaph zeigt die Graphische bestimmung der Copolymerisationskonstanten über die Fineman Methode.}
			\end{figure}

		Daraus ergeben sich die jeweiligen werte for $r_1 = 0,7802$ aus der Steigung und $r_2 = -0,3949$ aus dem Achsenabschnitt.

		%Sagen wie sie abweichen von Mayo methode und warum.
		...
		Dabei wird Gleichung (27) auf Gleichung (28) aufgetragen. Die Ergebnisse der Proben sind in Tabelle \ref{} gelistet und in Abb. \ref{} geplottet.
