...
\section{Auswertug}
	...
	\subsection{Standardmessung der Ferrocen/Ferrocenium Elektrode}
		...
		Dabei wurde eine Ferrocen/Ferrocenium (Fc/Fc$^+$) Elektrode verwendet mit einer Ag-Elektrode als Gegenelektrode.
...
\newpage
	...
	\subsection{Bestimmung der HOMO- und LUMO-Niveaus}
		...
		Wichtig anzumerken ist, dass bei Polymere kein Halbwertspotential bestimmt werden kann, da diese keine expliziten Kettenlängen besitzen. 
		...
		Vorgehen ist in Abbildung \ref{CV-P3HT-HOMOLUMO} zu erkennen.
			...
			\begin{figure}[H]
				\centering
				\includegraphics[scale = 0.5]{Bilder/P3HT_Tangents.png}
